...
<body>
<form action="${pageContext.request.contextPath}/mediplat/loginAction" method="post" id="login_form">
	<section>
		<div class="text-wrap">
			<div class="text-img">
			...
			<div class="main">
				...
				<div class="login-header">
					<span class="header-text">MediPlat</span>
				</div>
					...
					<div class="login-content">
						<div class="container">
							<div class="content">
								...
								<div class="pw-find">
									<span class="bold" onclick="location.href='${pageContext.request.contextPath}/mediplat/Findpwd'">비밀번호 찾기 ></span>
								</div>
								<div class="login-btn">
...
$("#loginbtn").click(function (){
	...
	var link = "${pageContext.request.contextPath}/mediplat/Main/${info.idx}"
	console.log("pwd : "+InputPwd);
	console.log("name : "+InputName);
	$.ajax({
		type : 'post',
		url : '${pageContext.request.contextPath}/mediplat/loginAction',
		datatype : 'json',
		data : {
			"id" : InputId,
			"pwd" : InputPwd,
...
function pwdlink() {
	var link = "${pageContext.request.contextPath}/mediplat/Pwd/"+idx;
	location.href = link;
}
function reset() {
	modal.classList.toggle('show');
