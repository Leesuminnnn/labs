...
<form action="${pageContext.request.contextPath}/demo/formAction/${info.idx}/${target.idx}">
	...
	<div class="section">
		...
		<!-- 
			...
			<div class="area" style="font-weight: bold; padding: 0;">
				<p>[ ${targetfirstName }ㅇㅇ ] 님의 평가가 완료 되었습니다.
    ...
    <p class="ps">코어솔루션대표이사&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<a style="border: 1px solid #000; padding: 15px; margin-bottom: 15px;; background-color: #D9EAD3; display: inline-block;" href="${pageContext.request.contextPath}/demo/Info/${info.idx}">평가대상자 목록 돌아가기</a>
				</div>
				</div>
	</div>
