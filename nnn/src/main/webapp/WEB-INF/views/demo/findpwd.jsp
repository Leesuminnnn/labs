...
<form action="${pageContext.request.contextPath}/demo/findpwdAction" method="post">
	...
	<div class="login">
		<div>
			<img style="cursor:pointer;" onclick="location.href='${pageContext.request.contextPath}/demo/Login'" src="${pageContext.request.contextPath}/resources/icon/arrow2.png">
			<h2>비밀번호 변경</h2>
		</div>
		<ul>
