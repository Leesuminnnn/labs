...
//		return sqlSession4.selectList(MAPPER+".evaluationtarget", map);
	}
...
//		return sqlSession4.selectList(MAPPER+".whetherselect", map);
	}
...
//		return sqlSession4.selectList(MAPPER+".evList", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".formcheck", map);
	}
...
//		return sqlSession4.insert(MAPPER+".forminsert", map);
	}
...
//		return sqlSession4.insert(MAPPER+".whether", map);
	}
...
//		return sqlSession4.update(MAPPER+".whetherUpdate", map);
	}
...
//		return sqlSession4.selectList(MAPPER+".target", map);
	}
...
//		return sqlSession4.selectList(MAPPER+".answerselect", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".targetsum", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".answersum", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".targetsum1", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".answersum1", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".targetsum2", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".answersum2", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".targetsum3", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".answersum3", map);
	}
...
//		return sqlSession4.insert(MAPPER+".scoreInsert", map);
	}
...
//		return sqlSession4.selectList(MAPPER+".scoreSelect", map);
	}
...
//		return sqlSession4.selectOne(MAPPER+".answerSelect", map);
	}
...
//		return sqlSession4.update(MAPPER+".formUpdate", map);
	}
