...
<body>
<form action="${pageContext.request.contextPath}/pro/loginAction" method="post" id="login_form">
	<section>
		<div class="text-wrap">
			<div class="text-img">
			...
			<div class="main">
				...
				<div class="login-header">
					<span class="header-text">코어솔루션 재물조사 시스템</span>
				</div>
					...
					<div class="login-content">
						<div class="container">
							<div class="content">
								...
								<div class="pw-find">
									<span class="bold" onclick="location.href='${pageContext.request.contextPath}/pro/Findpwd'">비밀번호 찾기 ></span>
								</div>
								<div class="login-btn">
...
$("#loginbtn").click(function (){
	...
	var link = "${pageContext.request.contextPath}/pro/main/${info.idx}"
	console.log("pwd : "+InputPwd);
	console.log("name : "+InputName);
	$.ajax({
		type : 'post',
		url : '${pageContext.request.contextPath}/pro/loginAction',
		datatype : 'json',
		data : {
			"id" : InputId,
			"pwd" : InputPwd,
		...
		success : function(response) {
			...
			if (res === "0") {
				...
				idx = response.idx;
				if (idx == 635) {
					location.href = "${pageContext.request.contextPath}/pro/admin";
				} else {
					location.href = "${pageContext.request.contextPath}/pro/main/"+idx;
				}
